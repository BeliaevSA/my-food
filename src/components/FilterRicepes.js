...
export const FilterRecipes = (props) => {
  ...
  return (
    <div className="filter-recipes">
      <FilterRecipesItem id='filter1' value='Творог' dataValue='творог 5%' onclick={props.changeStateFilter} />
      <FilterRecipesItem id='filter2' value='Индейка' dataValue='индей' onclick={props.changeStateFilter}/>
      <FilterRecipesItem id='filter3' value='Курица' dataValue='Куриное филе' onclick={props.changeStateFilter}/>
